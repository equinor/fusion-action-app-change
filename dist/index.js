...
const require$$0$4 = require("node:stream");
const require$$0$2 = require("node:buffer");
    ...
    parseControlFrame(body2) {
      ...
      if (opcode === opcodes.CLOSE) {
        ...
        if (this.ws[kSentClose] !== sentCloseFrameState.SENT) {
          let body22 = emptyBuffer;
          if (this.#info.closeInfo.code) {
            body22 = Buffer.allocUnsafe(2);
            body22.writeUInt16BE(this.#info.closeInfo.code, 0);
          }
          const closeFrame = new WebsocketFrameSend(body22);
